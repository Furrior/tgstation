...
if command -v rg >/dev/null 2>&1; then
	...
	code_files="code/**/**.dm modular_skyrat/**/**.dm modular_zubbers/**/**.dm modular_zzplurt/**/**.dm modular_zzz/**/**.dm" # SPLURT EDIT - Adds our modular folder # BUBBER EDIT - Adds modular folders
	map_files="_maps/**/**.dmm"
	...
	pcre2_support=0
	grep=grep
	code_files="-r --include=code/**/**.dm --include=modular_skyrat/**/**.dm --include=modular_zubbers/**/**.dm --include=modular_zzplurt/**/**.dm --include=modular_zzz/**/**.dm" # SPLURT EDIT - Adds our modular folder # BUBBER EDIT - Adds modular folders
