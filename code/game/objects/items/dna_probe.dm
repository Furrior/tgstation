...
/obj/item/dna_probe/carp_scanner/attack_self(mob/user, modifiers)
	...
	priority_announce("Вблизи [station_name()] зафиксирован большой поток органической энергии. Пожалуйста, будьте готовы к этому.", "ВНИМАНИЕ: НЕОПОЗНАННЫЕ ФОРМЫ ЖИЗНИ")
	qdel(src)
