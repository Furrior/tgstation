...
/proc/make_maint_all_access(silent = FALSE) // BUBBER EDIT CHANGE - Silent Emergency Access
	...
	if(!silent) // BUBBER EDIT ADDITION - Silent Emergency Access
		minor_announce("Ограничения на доступ к техническим тоннелям и внешним шлюзам сняты.", "ВНИМАНИЕ: Чрезвычайная Ситуация",1)
...
/proc/revoke_maint_all_access(silent = FALSE) // BUBBER EDIT CHANGE - Silent Emergency Access
	...
	if(!silent) // BUBBER EDIT ADDITION - Silent Emergency Access
		minor_announce("Ограничения доступа к техническим тоннелям и внешним шлюзам восстановлены.", "ВНИМАНИЕ: Чрезвычайная Ситуация Отменена")
