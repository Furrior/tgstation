...
/mob/eye/blob/process()
	if(!blob_core)
		...
		priority_announce("Биологическая опасность 5-го уровня достигла критической массы. Потеря станции неизбежна.", "ВНИМАНИЕ: Биологическая Опасность")
	...
	if(announcement_time && (world.time >= announcement_time || blobs_legit.len >= announcement_size) && !has_announced)
		priority_announce("Подтверждена вспышка биологической опасности 5-го уровня на борту [station_name()]. Весь персонал должен противостоять опасности.", "ВНИМАНИЕ: Биологическая Опасность", ANNOUNCER_OUTBREAK5)
