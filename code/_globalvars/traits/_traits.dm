...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_RAD_RESISTANCE" = TRAIT_RAD_RESISTANCE, // BUBBER EDIT
		...
		"TRAIT_SHADED" = TRAIT_SHADED, //BUBBER EDIT ADDITION
		...
		"TRAIT_SLIME_HYDROPHOBIA" = TRAIT_SLIME_HYDROPHOBIA, // MOON TRAIT
		"TRAIT_NONATURALHEAL" = TRAIT_NONATURALHEAL, // MOON TRAIT
	...
	/obj/item/organ/liver = list(
		...
		"TRAIT_CARGO_METABOLISM" = TRAIT_CARGO_METABOLISM, // SPLURT EDIT ADDITION - Packing peanuts
	),
	...
	/obj/item/toy/plush/skyrat = list(
		...
		"TRAIT_BOVINE" = TRAIT_BOVINE, // BUBBER ADDITION
		"TRAIT_CANINE" = TRAIT_CANINE,
		"TRAIT_MURIDAE" = TRAIT_MURIDAE, // BUBBER ADDITION
