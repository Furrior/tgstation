GLOBAL_LIST_INIT(common_loot, list( //common: basic items
	...
	list(
		...
		/obj/item/reagent_containers/applicator/pill/cyanide = 1,
		/obj/item/reagent_containers/applicator/pill/happy = 5,
		/obj/item/reagent_containers/applicator/pill/happinesspsych = 5,
		/obj/item/reagent_containers/applicator/pill/lsd = 5,
		/obj/item/reagent_containers/applicator/pill/lsdpsych = 5,
