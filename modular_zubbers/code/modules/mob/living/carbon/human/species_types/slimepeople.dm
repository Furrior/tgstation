#define SLIME_ACTIONS_ICON_FILE 'modular_skyrat/master_files/icons/mob/actions/actions_slime.dmi'
...
/datum/action/innate/core_signal
	...
	check_flags = AB_CHECK_CONSCIOUS
	button_icon = 'modular_skyrat/master_files/icons/obj/surgery.dmi'
