...
/datum/round_event/ghost_role/blob/announce(fake)
	...
	priority_announce("Подтверждена вспышка биологической опасности уровня 5 на борту [station_name()]. Весь персонал должен противостоять опасности.", "ВНИМАНИЕ: Биологическая Опасность", ANNOUNCER_OUTBREAK5)
