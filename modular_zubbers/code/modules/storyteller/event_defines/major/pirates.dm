...
/proc/send_pirate_threat(list/pirate_selection)
	...
	//send message
	priority_announce("Входящая подпространственная связь. Защищённый канал открыт на всех консолях связи.", "ВНИМАНИЕ: Вам Собщение", SSstation.announcer.get_rand_report_sound())
